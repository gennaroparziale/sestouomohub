            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user() && Auth::user()->is_admin)
                        ...
                        <x-nav-link :href="route('admin.partite-in-casa.index')" :active="request()->routeIs('admin.partite-in-casa.*')">
                            Partite in Casa
                        </x-nav-link>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('admin.annunci.index')">
                                        Annunci
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('admin.sondaggi.index')">
                                        Sondaggi
                                    </x-dropdown-link>
                                </x-slot>
                            </x-dropdown>
