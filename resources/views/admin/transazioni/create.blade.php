                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="metodo_pagamento" id="metodo_pagamento" class="block mt-1 w-full border-gray-300 ... rounded-md shadow-sm">
                                    ...
                                    <option value="Contanti" @selected(old('metodo_pagamento') == 'Contanti')>Contanti</option>
                                    <option value="Carta di Credito" @selected(old('metodo_pagamento') == 'Carta di Credito')>Carta di Credito</option>
                                    <option value="Bonifico Bancario" @selected(old('metodo_pagamento') == 'Bonifico Bancario')>Bonifico Bancario</option>
                                </select>
                            </div>
